      ...
      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto border-b border-champagne-300/40 pb-6 sm:pb-8">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl text-obsidian font-bold leading-[1.05] font-serif-luxury">
            Track your <span className="font-zapfino text-champagne-400 font-normal tracking-normal lowercase inline-block text-[34px] sm:text-[50px] md:text-[60px] leading-[0.9] px-1">parcel</span>.
          </h1>
