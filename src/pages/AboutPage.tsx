      ...
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        <div className="space-y-4 max-w-4xl border-b border-champagne-300/40 pb-8">
          ...
          <h1 className="font-serif-luxury text-5xl sm:text-7xl md:text-8xl text-obsidian font-normal leading-[0.92]">
            The soul of <span className="font-zapfino text-champagne-400 font-normal tracking-normal lowercase inline-block text-[44px] sm:text-[68px] md:text-[84px] leading-[0.9] px-1">celestia</span>.
          </h1>
