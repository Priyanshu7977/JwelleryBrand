  ...
  return (
    <>
      ...
      >
          ...
          >
            <div className="grid grid-cols-12 gap-8 items-center">
              ...
              <div className="col-span-7 space-y-3">
                <div className="flex items-center gap-2 text-[10px] uppercase tracking-monumental text-gold-dark font-semibold border-b border-champagne-300/40 pb-2">
                    ...
                    <Link
                      ...
                      className={`group flex items-center justify-between p-3.5 rounded-2xl transition-all ${
                        activeCategoryIndex === idx
                          ? 'bg-champagne-200/90 text-obsidian font-semibold shadow-sm border border-champagne-300/80 translate-x-1'
                          : 'text-obsidian hover:text-gold-dark hover:bg-champagne-100/60'
                      }`}
                    >
                      <div>
                        <p
                          className={`font-serif-luxury text-lg leading-tight font-bold ${
                            activeCategoryIndex === idx ? 'text-obsidian' : 'text-obsidian group-hover:text-gold-dark'
                          }`}
                        >
                          {cat.title}
                        </p>
                        <p
                          className={`text-[11px] font-sans ${
                            activeCategoryIndex === idx ? 'text-obsidian/85 font-medium' : 'text-obsidian-soft group-hover:text-obsidian'
                          }`}
                        >
                          {cat.description}
                        </p>
                      ...
                      <ArrowRight
                        className={`w-4 h-4 transition-all ${
                          activeCategoryIndex === idx ? 'opacity-100 text-gold-dark' : 'opacity-0 text-obsidian/40'
                        }`}
                      />
                    </Link>
                  ))}
              ...
              <div className="col-span-5 bg-white p-5 rounded-3xl border border-champagne-300/70 shadow-md space-y-4 text-left">
                ...
                <div className="space-y-1">
                  ...
                  <h4 className="font-serif-luxury text-lg text-obsidian font-bold leading-snug">
                    {currentMegaProduct.title}
                  </h4>
                  <p className="text-xs text-obsidian-soft line-clamp-2">
                    {currentMegaProduct.description}
                  </p>
                </div>
                <div className="flex items-center justify-between pt-2 border-t border-champagne-200">
                  <span className="font-serif text-lg text-gold-dark font-bold">₹{currentMegaProduct.price}</span>
                  <Link
                    to={`/product/${currentMegaProduct.handle}`}
                    className="text-xs uppercase font-mono tracking-widest text-gold-dark hover:text-obsidian font-bold hover:underline flex items-center gap-1 transition-colors"
                  >
        ...
        {/* ================================================================= */}
        {/* COLLECTIONS PREVIEW PANEL (Matching Pearl Luxury Glass Theme)     */}
        {/* ================================================================= */}
        {hoveredMenu === 'collections' && (
          ...
          >
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-champagne-300/40 pb-2">
                <span className="text-[10px] uppercase tracking-monumental text-gold-dark font-semibold">
                  Five Curated Realms
                </span>
                <Link to="/collections" className="text-xs uppercase tracking-widest text-gold-dark hover:text-obsidian font-medium transition-colors">
              ...
              <div className="grid grid-cols-5 gap-3">
                {CELESTIA_COLLECTIONS.map((col, i) => (
                  <Link
                    ...
                    className="group flex flex-col gap-2 p-2.5 rounded-2xl bg-white border border-champagne-300/60 shadow-sm hover:border-gold-dark hover:shadow-md transition-all text-left"
                  >
