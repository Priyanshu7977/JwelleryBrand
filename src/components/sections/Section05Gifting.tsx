...
import { Gift, Sparkles, Image as ImageIcon, Check, Heart, Plus, Trash2, ArrowRight } from 'lucide-react';
...
export const Section05Gifting: React.FC = () => {
  ...
  return (
    <section
      id="section-gifting"
      className="relative w-full py-20 md:py-28 px-6 md:px-12 lg:px-20 bg-blush-50/60 overflow-hidden border-t border-champagne-300/30"
    >
      {/* Soft Ambient Blush and Warm Light */}
      <div className="absolute top-10 left-1/3 w-[600px] h-[600px] bg-blush-100/50 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-[1500px] mx-auto space-y-14">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-pearl-100 border border-blush-200 text-[11px] uppercase tracking-widest text-gold-dark font-medium shadow-sm">
          ...
          <h2 className="font-serif-luxury text-4xl sm:text-6xl md:text-7xl text-obsidian uppercase font-normal leading-[0.95]">
            FOR SOMEONE <span className="italic font-light lowercase text-gold-dark">special.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-8 bg-pearl-100/80 p-6 md:p-10 rounded-3xl border border-champagne-300/50 shadow-luxury-soft backdrop-blur-sm">
