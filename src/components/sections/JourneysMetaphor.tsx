      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto border-b border-champagne-300/40 pb-8">
          ...
          <h2 className="font-serif-luxury text-4xl sm:text-6xl md:text-7xl text-obsidian font-normal leading-[0.95]">
            <AnimatedCounter target={1000} suffix="+" /> <span className="font-zapfino text-champagne-400 font-normal tracking-normal capitalize inline-block text-[34px] sm:text-[50px] md:text-[60px] leading-[0.9] px-1">Journeys</span>.
          </h2>
