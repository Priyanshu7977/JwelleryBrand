      ...
      <div className="max-w-7xl mx-auto space-y-10 sm:space-y-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="mt-3 sm:mt-0 sm:absolute sm:-bottom-5 sm:-right-3 p-3.5 sm:p-4 bg-espresso-charcoal/95 backdrop-blur-md rounded-2xl shadow-2xl border border-champagne-400/50 max-w-xs space-y-1">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-3 pt-3 border-t border-champagne-400/25">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {founderCurations.map((item) => (
                  ...
                  >
                    <div className="aspect-[4/3] rounded-xl overflow-hidden bg-espresso-deep relative">
                      <img
                    ...
                    <div className="flex gap-1.5 pt-1">
                      <button
                        ...
                        className="flex-1 h-8 bg-champagne-300 hover:bg-champagne-200 text-obsidian text-[10px] uppercase font-bold tracking-wider rounded-full transition-colors flex items-center justify-center gap-1"
                      >
                      ...
                      <button
                        ...
                        className="w-8 h-8 border border-champagne-400/40 hover:bg-champagne-400/20 text-pearl-50 rounded-full transition-colors flex items-center justify-center shrink-0"
                        title="Quick View"
                      >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              <Link
                to="/the-world"
                className="h-11 px-6 rounded-full bg-champagne-300 hover:bg-champagne-200 text-obsidian text-xs uppercase tracking-widest font-bold transition-all inline-flex items-center justify-center gap-2 shadow-lg"
              >
              ...
              <a
                ...
                className="h-11 px-6 rounded-full border border-champagne-400/40 hover:bg-champagne-400/20 text-pearl-50 text-xs uppercase tracking-widest font-bold transition-all inline-flex items-center justify-center gap-2"
              >
