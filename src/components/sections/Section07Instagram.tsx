  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto space-y-8 sm:space-y-10">
        ...
        {/* Dynamic Editorial Collage - Proportioned on Screen */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
          {INSTAGRAM_POSTS.map((post) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative rounded-2xl overflow-hidden bg-sand shadow-sm hover:shadow-luxury-soft transition-all duration-300 group aspect-square max-h-[190px]"
            >
              <img
                src={post.mediaUrl}
                alt={post.caption}
